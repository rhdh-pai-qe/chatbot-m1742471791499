...
3) Access the `workbench` named `chatbot-m1742471791499-notebook`.
...
5) In the terminal, run `cd chatbot-m1742471791499` to navigate to your sample app's directory.
